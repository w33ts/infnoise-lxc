...
2. Pick a new semantic version tag such as `v0.1.4`.
...
git commit -am "Prepare v0.1.4 release"
git tag v0.1.4
...
- `infnoise-lxc-v0.1.4.tar.gz`
- `infnoise-lxc-v0.1.4.sha256`

You can also verify the checksum after downloading:

```bash
sha256sum -c infnoise-lxc-v0.1.4.sha256
```
